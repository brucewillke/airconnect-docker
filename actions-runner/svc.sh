...
SVC_NAME="actions.runner.brucewillke-airconnect-docker.willkeworld.service"
SVC_DESCRIPTION="GitHub Actions Runner (brucewillke-airconnect-docker.willkeworld)"
